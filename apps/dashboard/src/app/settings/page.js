  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <div className="setting-row"><span className="avatar sq">4</span><span className="t">Populate the Catalogue with real data<small>Courses, states, colleges & documents — via the Catalogue editor</small></span></div>
